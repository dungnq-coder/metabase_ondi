...
class TimelineEventAPI(Base):
    ...
    def post_timeline_event_action(self,
                         payload: dict = None):
        """
    ...
    def get_create_timeline_event_payload(self, question_id: int = None,
                                          timezone: str = "",
                                          timestamp: str = "",
                                          name:str = "",
                                          archived: bool = False,
    ...
    def get_update_timeline_event_payload(self, archived: bool = False, 
                                    description: str = "", 
                                    icon: str = "start", 
                                    name: str = "",
                                    time_matters: bool = True,
